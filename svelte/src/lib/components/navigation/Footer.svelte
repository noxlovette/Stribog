<footer class="flex w-full flex-col items-center justify-between bg-stone-900 pt-3">
	...
	<a href="/" class="tracking text-[15rem] font-semibold tracking-tight text-stone-700 transition"
		>Stribog</a
	>
	<p class="flex items-center py-3 text-stone-500">© 2025 Danila Volkov</p>
</footer>
